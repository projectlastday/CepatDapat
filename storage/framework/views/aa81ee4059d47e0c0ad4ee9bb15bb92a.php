        ...
        <div class="col-sm-12">
            ...
            <div class="row">
                <div class="col-sm-12">
                    ...
                    <div class="mb-4">
                        <form action="<?php echo e(route('admin.deleted_auctions')); ?>" method="GET" class="d-flex gap-2">
                                    ...
                                    <div class="card-body d-flex flex-column">
                                        ...
                                        <div class="mt-auto">
                                            ...
                                            <div class="badge bg-dark w-100 py-2 fw-bold">
                                                <?php echo e(ucfirst($item->status)); ?> (Terhapus)
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                        ...
                                        <div class="modal-body p-4">
                                                ...
                                                <table class="table table-bordered table-striped">
                                                    <tbody>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td><span
                                                                    class="badge bg-secondary"><?php echo e(ucfirst($item->status)); ?></span>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <th>Tanggal Input</th>
                                            ...
                                            <div class="d-grid">
                                                <button class="btn btn-success fw-bold" type="button"
                                                    onclick="openRestoreModal(<?php echo e($item->id_lelang); ?>, '<?php echo e($item->nama_barang); ?>')">
            ...
            <div class="modal fade" id="modalRestoreAuction" tabindex="-1" aria-hidden="true">
                <div class="modal-dialog modal-dialog-centered">
                    <div class="modal-content border-0 shadow-lg rounded-4">
                        ...
                        <form action="<?php echo e(route('admin.restore_auction')); ?>" method="POST">
                            <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\jason\Documents\Brian\CepatDapat_new\resources\views\auction\lelang_terhapus.blade.php ENDPATH**/ ?>