                        ...
                        <form method="POST" action="/forgot-password" id="forgotForm">
                                ...
                                <div class="d-flex gap-3">
                                    <div class="form-check">
                                        <input class="form-check-input" type="radio" name="method" value="email"
                                            id="methodEmail" <?php echo e(old('method', 'email') === 'email' ? 'checked' : ''); ?>>
                                    ...
                                    <div class="form-check">
                                        <input class="form-check-input" type="radio" name="method" value="telepon"
                                            id="methodTelepon" <?php echo e(old('method') === 'telepon' ? 'checked' : ''); ?>>
                            ...
                            <div class="mb-3" id="teleponGroup" style="display: none;">
                                ...
                                <input type="text" class="form-control" id="telepon" name="telepon"
                                    placeholder="08xxxxxxxxxx" value="<?php echo e(old('telepon')); ?>">
                            </div>
...
</html><?php /**PATH C:\Users\jason\Documents\Brian\CepatDapat_new\resources\views\auth\forgot-password.blade.php ENDPATH**/ ?>