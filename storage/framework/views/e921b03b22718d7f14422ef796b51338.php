    ...
    <nav class="pc-sidebar">
        <div class="navbar-wrapper">
            ...
            <div class="navbar-content">
                <ul class="pc-navbar">
                    <?php if(\App\Helpers\PermissionHelper::check('dashboard_view')): ?>
                        <li class="pc-item">
                    ...
                    <?php endif; ?>
                    <?php if(\App\Helpers\PermissionHelper::check('report_view')): ?>
                        <li class="pc-item">
                    ...
                    <li class="pc-item">
                        <a href="/dapat" class="pc-link">
                            <span class="pc-micon">
                                <i class="ti ti-trophy" style="font-size: 20px;"></i>
                            </span>
                            <span class="pc-mtext">Dapat / Barang Menang</span>
                        </a>
                    </li>
                    <?php if(\App\Helpers\PermissionHelper::check('moderation_view')): ?>
                        <li class="pc-item">
                    ...
                    <?php if(\App\Helpers\PermissionHelper::checkAny(['auction_manage_view', 'auction_canceled_view', 'auction_deleted_view'])): ?>
                        <li class="pc-item pc-hasmenu">
                            ...
                            <ul class="pc-submenu">
                                <?php if(\App\Helpers\PermissionHelper::check('auction_manage_view')): ?>
                                    <li class="pc-item">
                                        <a class="pc-link" href="/manajemen-lelang">Manajemen Lelang</a>
                                    </li>
                                <?php endif; ?>
                                <?php if(\App\Helpers\PermissionHelper::check('auction_canceled_view')): ?>
                                    <li class="pc-item">
                                        <a class="pc-link" href="/lelang-tercancel">Lelang Tercancel</a>
                                    </li>
                                <?php endif; ?>
                                <?php if(\App\Helpers\PermissionHelper::check('auction_deleted_view')): ?>
                                    <li class="pc-item">
                    ...
                    <?php endif; ?>
                    <?php if(\App\Helpers\PermissionHelper::check('history_view')): ?>
                        <li class="pc-item">
        ...
        <div class="header-wrapper">
            ...
            <div class="ms-auto d-flex align-items-center">
                <div class="me-3 d-none d-md-block">
                    <span class="fw-bold text-dark h5 mb-0"><?php echo e(session('username')); ?></span>
                </div>
                    ...
                    <li class="dropdown pc-h-item header-user-profile">
                        ...
                        <div class="dropdown-menu dropdown-user-profile dropdown-menu-end pc-h-dropdown">
                            <div class="dropdown-header">
                                <?php if(\App\Helpers\PermissionHelper::check('setting_view')): ?>
...
</html><?php /**PATH /Users/brian/Files/Web Project/CepatDapat_new/resources/views/layouts/app.blade.php ENDPATH**/ ?>