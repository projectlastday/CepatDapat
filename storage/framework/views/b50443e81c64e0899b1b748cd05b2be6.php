                            ...
                            <div class="col-sm-6 col-md-4 col-xl-3">
                                <div class="card auction-card shadow-sm h-100 position-relative">
                                    ...
                                    <div class="card-body d-flex flex-column">
                                        ...
                                        <p class="price-tag mb-3 mt-2">Rp <?php echo e(number_format($item->winning_bid, 0, ',', '.')); ?></p>
                                            ...
                                            <div class="table-responsive">
                                                <table class="table table-bordered table-striped">
                                                    <tbody>
                                                        ...
                                                        <tr>
                                                            <th>Harga Menang</th>
                                                            <td class="fw-bold text-success">Rp <?php echo e(number_format($item->winning_bid, 0, ',', '.')); ?></td>
                                                        </tr>
                                                        <tr>
                                                            <th>Penjual</th>
                                                            <td><?php echo e($item->owner_username); ?></td>
                                                        </tr>
                                                        <tr>
                                                            <th>Telepon Penjual</th>
                                                            <td><?php echo e($item->owner_telepon ?? '-'); ?></td>
                                                        </tr>
                                                        <tr>
                                                            <th>Foto</th>
                                                            <td>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/brian/Files/Web Project/CepatDapat_new/resources/views/auction/dapat.blade.php ENDPATH**/ ?>