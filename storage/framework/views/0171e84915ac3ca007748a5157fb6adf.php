                    ...
                    <div class="tab-content" id="settingTabsContent">
                        ...
                        <div class="tab-pane fade show active" id="logo-param" role="tabpanel" aria-labelledby="logo-tab">
                            <div class="row align-items-center">
                                ...
                                <div class="col-md-7">
                                    <form action="<?php echo e(route('setting.update_logo')); ?>" method="POST"
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="tab-pane fade" id="access-param" role="tabpanel" aria-labelledby="access-tab">
                            ...
                            <form action="<?php echo e(route('SettingController.updateHakAkses')); ?>" method="POST">
                                <?php echo csrf_field(); ?>
                                    ...
                                    <table class="table table-bordered table-hover align-middle">
                                        <thead class="table-light text-center">
                                            <tr>
                                                ...
                                                <?php $__currentLoopData = $hak_akses['roles']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $roleId => $roleLabel): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <th><?php echo e($roleLabel); ?></th>
                                        ...
                                        <tbody>
                                            ...
                                            <?php $__currentLoopData = $hak_akses['features']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $fKey => $fMeta): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                
                                                <?php if($currentGroup !== $fMeta['group']): ?>
                                                    <?php $currentGroup = $fMeta['group']; ?>
                                                    <tr class="table-secondary">
                                                        <td colspan="<?php echo e(count($hak_akses['roles']) + 1); ?>"
                                                            class="fw-bold text-uppercase small px-3 py-2">
                                                            <?php echo e($currentGroup); ?>
                                                ...
                                                <tr>
                                                    <td class="px-3">
                                                        <span class="fw-medium"><?php echo e($fMeta['label']); ?></span>
                                                        <div class="small text-muted fst-italic"><?php echo e($fKey); ?></div>
                                                    </td>
                                                    <?php $__currentLoopData = $hak_akses['roles']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $roleId => $roleLabel): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                        <td class="text-center">
                                                            <div class="form-check d-flex justify-content-center">
                                                                <input class="form-check-input" type="checkbox"
                                                                    name="permissions[<?php echo e($fKey); ?>][<?php echo e($roleId); ?>]" value="on" <?php echo e(isset($hak_akses['matrix'][$fKey][$roleId]) && $hak_akses['matrix'][$fKey][$roleId] ? 'checked' : ''); ?>>
                                                            </div>
                                                        </td>
                                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                </tr>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/brian/Files/Web Project/CepatDapat_new/resources/views/admin/setting_website.blade.php ENDPATH**/ ?>