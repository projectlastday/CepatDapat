        ...
        <div class="navbar-wrapper">
            <div class="m-header">
                <a href="/" class="b-brand text-primary">
                    <img src="{{ asset($site_settings['logo'] ?? 'assets/images/CepatDapat.png') }}"
                        style="width:70%" />
                </a>
            </div>
                ...
                <ul class="pc-navbar">
                    ...
                    <li class="pc-item">
                        <a href="/catalog" class="pc-link">
                            <span class="pc-micon">
                                <img src="{{ asset('assets/images/bag.svg') }}" alt="logo"
                    ...
                    <li class="pc-item">
                        <a href="/auction-add" class="pc-link">
                            <span class="pc-micon">
                                <img src="{{ asset('assets/images/bag-plus-fill.svg') }}" alt="bag plus fill"
                                    style="width: 20px; height: 20px;">
                            </span>
                    ...
                    <li class="pc-item">
                        <a href="/lelangku" class="pc-link">
                            <span class="pc-micon">
                                <img src="{{ asset('assets/images/clock-history.svg') }}" alt="lelangku"
                                    style="width: 20px; height: 20px;">
                            </span>
                    ...
                    @if (\App\Helpers\PermissionHelper::checkAny(['auction_manage_view', 'auction_canceled_view', 'auction_deleted_view']))
                        <li class="pc-item pc-hasmenu">
                            ...
                            <ul class="pc-submenu">
                                ...
                                @endif
                                @if(\App\Helpers\PermissionHelper::check('auction_canceled_view'))
                                    <li class="pc-item">
                                        <a class="pc-link" href="/lelang-tercancel">Lelang Tercancel</a>
                                    </li>
                                @endif
                                @if(\App\Helpers\PermissionHelper::check('auction_deleted_view'))
                                    <li class="pc-item">
        ...
        <div class="header-wrapper">
            ...
            <div class="ms-auto d-flex align-items-center">
                <div class="me-3 d-none d-md-block">
                    <span class="fw-bold text-dark h5 mb-0">{{ session('username') }}</span>
                </div>
